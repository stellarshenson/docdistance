...
- `education-wmd-explainer.log` - nbconvert execution log for `notebooks/education/01-kj-wmd-smd-explainer.ipynb` (step-by-step WMD/SMD optimal-transport explainer on two toy documents: statements to embeddings, ground cost M, marginals, the exact transport plan T, the distance, the recovered alignment, the WCD/RWMD/SMD bounds, and the order-invariance check)
- `E10-structure-sensitive.log` - nbconvert execution of the E10 batch (structure-sensitive, content-invariant distances seeking translation-invariance AND scramble-monotonicity together: content-pinned Gromov distortion E10-H54, OPW order-gap E10-H55, source-anchored Kendall-tau E10-H56, shared-codebook edit distance E10-H57, soft-DTW divergence order-gap E10-H58; per-hypothesis shift/scramble/paraphrase/triangle checks vs the E08-H44 posaug and naive greedy-1-NN baselines)
